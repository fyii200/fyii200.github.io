...
*PS, this is just the repository for the site where code, figures, etc. are stored. I also give a not too geeky-techie but rather convoluted overview of the background of my PhD below. If you only have 1 minute, you probably want to read the [super truncated version](https://fyii200.github.io/about/) instead. **[Actual site can be found here](https://fyii200.github.io).*** 
